# Judikatur / Vergabekontrollbehörden
...
Entscheidungen der Vergabekontrollbehörden.

## Offizielle Quellen

- Handbuch: `OGD-RIS API Handbuch V2_6`
- Example-UI: `Examples/verg.html`
...
curl -sG 'https://data.bka.gv.at/ris/api/v2.6/Judikatur' \
  --data-urlencode 'Applikation=Verg' \
  --data-urlencode 'Suchworte=Vergabe' \
