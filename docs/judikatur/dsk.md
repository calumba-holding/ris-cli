# Judikatur / Datenschutzbehörde / Datenschutzkommission
...
Entscheidungen der Datenschutzbehörde bzw. Datenschutzkommission.

## Offizielle Quellen

- Handbuch: `OGD-RIS API Handbuch V2_6`
- Example-UI: `Examples/dsk.html`
...
curl -sG 'https://data.bka.gv.at/ris/api/v2.6/Judikatur' \
  --data-urlencode 'Applikation=Dsk' \
